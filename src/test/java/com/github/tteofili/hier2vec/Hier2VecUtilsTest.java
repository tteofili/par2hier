...
/**
 * Tests for {@link Hier2VecUtils}
 */
public class Hier2VecUtilsTest {
  ...
  public void testSVDPCA() throws Exception {
    ...
    Map<String, INDArray> svdPCA = Hier2VecUtils.svdPCA(weightTable, 2);
  ...
  public void testTruncatedUT() throws Exception {
    ...
    double[][] truncatedUT = Hier2VecUtils.getTruncatedUT(Nd4j.create(data), 3);
  ...
  public void testTruncatedVT() throws Exception {
    ...
    double[][] truncatedVT = Hier2VecUtils.getTruncatedVT(Nd4j.create(data), 3);
